      ...
      >
        ...
        <div className="relative w-full max-w-lg transform transition-all duration-300 ease-out animate-scale-in">
          <div
            className={`
            ${classes.bg.elevated} 
            rounded-2xl shadow-soft-xl border ${classes.border.light}
          ...
          >
            ...
            <div
              className={`
              flex items-center justify-between p-6 sm:p-8
              border-b ${classes.border.default}
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2
                    className={`text-xl sm:text-2xl font-bold ${classes.text.primary}`}
                  >
                    Profile Settings
                  </h2>
                  <p className={`text-sm ${classes.text.secondary} mt-0.5`}>
