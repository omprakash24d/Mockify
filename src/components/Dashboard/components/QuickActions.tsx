        ...
        {quickActions.map((action) => {
          ...
          return (
            <button
              ...
              className={`h-32 ${action.bgColor} rounded-xl p-6 flex flex-col items-center justify-center gap-3 group transition-all duration-300 hover:scale-105 hover:shadow-lg`}
            >
              ...
              <div className="text-center">
                ...
                <span
                  className={`text-sm ${
                    action.primary ? "opacity-90" : "opacity-75"
                  }`}
                >
                  {action.subtitle}
                </span>
